...
class MenuPrincipal(Screen):
    def __init__(self, **kwargs):
        ...
        btn_misiones = Button(text="MISIONES DIARIAS", font_size='18sp', size_hint_y=None, height=50, background_color=(0.2, 0.6, 0.8, 1))
        ...
        layout_botones.add_widget(btn_misiones)
