...
class MenuPrincipal(Screen):
    def __init__(self, **kwargs):
        ...
        layout_botones2 = BoxLayout(orientation='horizontal', spacing=12, size_hint_x=1, pos_hint={'center_x': 0.5})
        ...
        layout_misiones_pase = BoxLayout(orientation='horizontal', spacing=12, size_hint_x=1, pos_hint={'center_x': 0.5})
        btn_misiones = Button(text="MISIONES DIARIAS", font_size='17sp', size_hint_y=None, height=50, background_color=(0.2, 0.6, 0.8, 1))
        btn_pase = Button(text="PASE DE BATALLA", font_size='17sp', size_hint_y=None, height=50, background_color=(0.85, 0.55, 0.1, 1))
